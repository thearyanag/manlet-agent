...
const swarmOps: SolanaSwarmOperations = new SolanaSwarmOperations();
...
app.post(
    '/create-token',
    async (req: Request<{}, GenericResponse, CreateTokenRequest>, res: Response<GenericResponse>) => {
        try {
...
app.post(
    '/transfer-asset',
    async (req: Request<{}, GenericResponse, TransferAssetRequest>, res: Response<GenericResponse>) => {
        try {
            const { amount, assetId, destinationAddress } = req.body;
            const result = await swarmOps.transferAsset(amount, assetId, destinationAddress);
            res.json({ success: true, data: result });
        } catch (error: any) {
            res.status(500).json({ success: false, error: error.message });
        }
...
app.post(
    '/get-balance',
    async (req: Request<{}, { balance: string }, GetBalanceRequest>, res: Response<{ balance: string } | { error: string }>) => {
        try {
...
app.post(
    '/deploy-nft',
    async (req: Request<{}, GenericResponse, DeployNFTRequest>, res: Response<GenericResponse>) => {
        try {
...
app.post(
    '/mint-nft',
    async (req: Request<{}, GenericResponse, MintNFTRequest>, res: Response<GenericResponse>) => {
        try {
...
app.post(
    '/generate-art',
    async (req: Request<{}, GenericResponse, GenerateArtRequest>, res: Response<GenericResponse>) => {
        try {
